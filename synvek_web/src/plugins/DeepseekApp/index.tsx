...
<script>
  ...
  window.addEventListener('resize', () => {    
    ...
    // console.log("Container1 height=" + document.body.style.height)
    // console.log("Container2 height=" + document.body.style.height)
    // console.log("Container3 height=" + container.style.height)
    // let content = document.getElementById('web-content');    
  ...
  <iframe id="webContent" class="web-content" src="https://www.deepseek.com"/>
  `,
}

export default DeepseekApp
