...
export const modelProviders: ModelProvider[] = [
  ...
  },
  {
    ...
    modelOptions: [
      ...
      { name: 'Qwen/Qwen3-0.6B-FP8', fileSize: '1GB', repos: [{ repoName: 'Qwen/Qwen3-0.6B-FP8' }], files: [] },
      { name: 'Qwen/Qwen3-1.7B-FP8', fileSize: '4GB', repos: [{ repoName: 'Qwen/Qwen3-1.7B-FP8' }], files: [] },
      { name: 'Qwen/Qwen3-4B-FP8', fileSize: '8GB', repos: [{ repoName: 'Qwen/Qwen3-4B-FP8' }], files: [] },
      { name: 'Qwen/Qwen3-8B-FP8', fileSize: '16GB', repos: [{ repoName: 'Qwen/Qwen3-8B-FP8' }], files: [] },
      { name: 'Qwen/Qwen3-14B-FP8', fileSize: '28GB', repos: [{ repoName: 'Qwen/Qwen3-14B-FP8' }], files: [] },
